...
public class ProwadzacyUsunietyOkno extends JPanel
{
	public ProwadzacyUsunietyOkno(JPanel panel)
    {
        ...
        JTextArea okMessage = new JTextArea("Prowadzacy usuniety z realizacji");
